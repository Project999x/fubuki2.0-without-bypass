...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7955067262:AAFXVNfjF_wiiyC9TQPxPKRM5pwB3KGCo3E")
...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002870650497"))
...
try:
    ADMINS=[1418213560]
    for x in (os.environ.get("ADMINS", "6587003349 7827448605 8160777407 7825167400").split()):
        ADMINS.append(int(x))
except ValueError:
